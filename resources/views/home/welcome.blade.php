				  	...
				  	<div class="box-body">
					    <div class="form-group col-lg-3">
					      ...
					      <select class="form-control" name="game_week" id="game_week">
		                    ...
		                    <option disabled>Week 6</option>
		                    <option disabled>Week 7</option>
		                    <option disabled>Week 8</option>
		                    <option disabled>Week 9</option>
		                    <option disabled>Week 10</option>
		                    <option disabled>Week 11</option>
		                    <option disabled>Week 12</option>
		                    <option disabled>Week 13</option>
		                    <option disabled>Week 14</option>
		                    <option disabled>Week 15</option>
					    ...
					    <div class="form-group col-lg-9">
					      ...
					      <select class="form-control" name="nfl_game_id">
					      	<option value="1">Team 1 v Team 2</option>
					      </select>
					    </div>
